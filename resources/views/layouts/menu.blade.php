...
@if ($doctorMGT)
    <div class="menu-item menu-accordion side-menus">
        <a class="menu-link menu-text-wrap {{ Request::is('doctors*','doctor-departments*', 'doctor-designations*', 'doctor-categories*','schedules*','prescriptions*') ? 'active' : '' }}"
           href="{{ $doctorMGT }}">
            ...
            <span class="d-none">{{__('messages.doctor_designations')}}</span>
            <span class="d-none">{{__('messages.doctor_categories')}}</span>
