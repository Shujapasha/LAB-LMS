...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('designation_name', __('messages.doctor_designation.doctor_designation').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::select('doctor_designation_id', $doctorsDesignations, null, ['class' => 'form-select form-select-solid', 'id' => 'doctorDesignationId', 'placeholder' => 'Select Designation', 'data-control' => 'select2','required']) }}
        </div>
    </div>
    <div class="form-group col-sm-6  mb-5">
        {{ Form::label('category_name', __('messages.doctor_category.doctor_categories').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('doctor_category_id', $doctorsCategories, null, ['class' => 'form-select form-select-solid', 'id' => 'doctorCategoryId', 'placeholder' => 'Select Category', 'data-control' => 'select2','required']) }}
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="form-group col-md-4 mb-5">
     ...
     <div class="form-group col-md-4 mb-5">
        <div class="row2">
            <label class="fs-5 fw-bold mb-2 d-block" for="image"> <span>{{__('messages.profile.cnic')}}: </span>
                <i class="fa fa-question-circle ms-1 fs-7" data-bs-toggle="tooltip"
                   title="Best resolution for this profile will be 325x375"></i>
            </label>
            <div class="image-input image-input-outline" data-kt-image-input="true">
            ...
            <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                   ...
                   title="Change profile">
                <i class="bi bi-pencil-fill fs-7"></i>
                <input type="file" name="cnicimage" id="cnicImage" accept=".png, .jpg, .jpeg, .gif"/>
                <input type="hidden" name="avatar_remove"/>
            </label>
            <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                  data-kt-image-input-action="cancel" data-bs-toggle="tooltip" data-bs-dismiss="click"
    ...
    <div class="form-group col-sm-4 mb-5">
        {{ Form::label('file', __('messages.profile.transcript').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        <?php
        $style = 'style=';
        $background = 'background-image:';
        ?>
        ...
        <label
            ...
            <i class="bi bi-pencil-fill fs-7"></i>
            {{ Form::file('transcript',['id'=>'documentImage','class' => 'd-none']) }}
            <input type="hidden" name="avatar_remove">
        </label>
        <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
    ...
    <div class="form-group col-sm-4 mb-5">
        {{ Form::label('file', __('messages.profile.offerletter').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        <?php
        $style = 'style=';
        $background = 'background-image:';
        ?>
        ...
        <label
                ...
                data-bs-original-title="Change attachment">
            <i class="bi bi-pencil-fill fs-7"></i>
            {{ Form::file('offerletter',['id'=>'offerLetter','class' => 'd-none']) }}
            <input type="hidden" name="avatar_remove">
        </label>
        <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                  data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title=""
