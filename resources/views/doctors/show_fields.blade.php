    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-body pt-9 pb-0">
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                <div class="me-7 mb-4">
                    <!-- @php
                        echo $doctorData->user->image_url;
                        echo $doctorData->user->cnic_url;
                        echo $doctorData->user->transcript_url;
                        echo $doctorData->user->offer_letter_url;
                    @endphp -->
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div>
                    <div class="card-body  border-top p-9">
                        ...
                        <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">{{ __('messages.user.cnic') }}</label>
                            <div class="col-lg-8">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    <img src="{{$doctorData->user->cnic_url}}" class="object-fit-cover" alt="image"/>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    <a href="{{$doctorData->user->transcript_url}}">View Transcript</a>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    <a href="{{$doctorData->user->offer_letter_url}}">View Offer Letter</a>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-7">
