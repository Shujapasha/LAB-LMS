...
mix.js('resources/assets/js/custom/custom.js',
    ...
    'public/assets/js/doctors_departments/doctor_departments_list.js').js('resources/assets/js/doctors_designations/doctor_designations.js',
    'public/assets/js/doctors_designations/doctor_designations.js').js('resources/assets/js/doctor_referral/doctor_referral.js',
    'public/assets/js/doctor_referral/doctor_referral.js').js('resources/assets/js/investigation_reports/investigation_reports.js',
    ...
    'public/assets/js/case_handlers/case_handlers.js').js('resources/assets/js/case_handlers/create-edit.js',
