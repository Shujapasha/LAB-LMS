...
use App\Http\Controllers\DoctorDesignationController;
...
//        Route::post('departments/{department}/active-deactive', 'DepartmentController@activeDeactiveDepartment');
        ...
        //Doctor Designation routes

        Route::get('doctor-designations',
            'DoctorDesignationController@index')->name('doctor-designations.index');
        Route::post('doctor-designations', 'DoctorDesignationController@store')->name('doctor-designations.store');
        Route::get('doctor-designations/create', 'DoctorDesignationController@create')->name('doctor-designations.create');
        Route::delete('doctor-designations/{doctorDesignation}', 'DoctorDesignationController@destroy')
            ->name('doctor-designations.destroy');
        Route::patch('doctor-designations/{doctorDesignation}', 'DoctorDesignationController@update')
            ->name('doctor-designations.update');
        Route::get('doctor-designations/{doctorDesignation}/edit', 'DoctorDesignationController@edit')
            ->name('doctor-designations.edit');

        //End

        //Doctor Category routes

        Route::get('doctor-categories',
            'DoctorCategoryController@index')->name('doctor-categories.index');
        Route::post('doctor-categories', 'DoctorCategoryController@store')->name('doctor-categories.store');
        Route::get('doctor-categories/create', 'DoctorCategoryController@create')->name('doctor-categories.create');
        Route::delete('doctor-categories/{doctorCategory}', 'DoctorCategoryController@destroy')
            ->name('doctor-categories.destroy');
        Route::patch('doctor-categories/{doctorCategory}', 'DoctorCategoryController@update')
            ->name('doctor-categories.update');
        Route::get('doctor-categories/{doctorCategory}/edit', 'DoctorCategoryController@edit')
            ->name('doctor-categories.edit');

        //End

        // Referrals

        Route::get('doctor-referrals',
            'ReferralController@index')->name('doctor-referrals.index');
        Route::post('doctor-referrals', 'ReferralController@store')->name('doctor-referrals.store');
        Route::get('doctor-referrals/create', 'ReferralController@create')->name('doctor-referrals.create');
        Route::delete('doctor-referrals/{doctorReferral}', 'ReferralController@destroy')
            ->name('doctor-referrals.destroy');
        Route::patch('doctor-referrals/{doctorReferral}', 'ReferralController@update')
            ->name('doctor-referrals.update');
        Route::get('doctor-referrals/{doctorReferral}/edit', 'ReferralController@edit')
            ->name('doctor-referrals.edit');
