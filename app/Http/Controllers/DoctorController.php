...
class DoctorController extends AppBaseController
{
    ...
    public function create()
    {
        ...
        $doctorsDesignations = getDoctorsDesignations();
        $doctorsCategories = getDoctorsCategories();

        $bloodGroup = getBloodGroups();

        return view('doctors.create', compact('doctorsDepartments', 'doctorsDesignations', 'doctorsCategories', 'bloodGroup'));
    }
